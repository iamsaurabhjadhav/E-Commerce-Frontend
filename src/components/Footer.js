            ...
            <div className='col-4'>
              ...
              <div>
                <address className='text-white fs-6'>
                  Hno : 227 Near Ganpati Temple Lohagaon,<br /> Pune, Maharashtra <br />
                  Pincode: 14478
                </address>
                <a href='tel:+91 90226053896' className='mt-3 d-block mb-1 text-white'> +91 90226053896 </a>
                <a href='mailto:saurabh@gmail.com' className='mt-2 d-block mb-0  text-white'> saurabh@gmail.com </a>
          ...
          <div className='row'>
            <div className='col-12'>
              <p className='text-center mb-0 text-white'>
                &copy; {new Date().getFullYear()}; Powered by Shippi's Corner</p>
            </div>
          </div>
        </div>
      </footer>
