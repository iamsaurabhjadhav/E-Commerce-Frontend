          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:<a className='text-white' href='tel:+91 9022605311'>+91 9022605311</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <header className='header-upper py-3'>
        <div className='container-xxl'>
          <div className='row' align-items-center>
            <div className='col-2'>
              <h2>
                <Link className='text-white'>Shippi</Link>
              </h2>
            </div>
            <div className='col-5'>
                ...
                <div>
                  <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      ...
                      <li><Link className="dropdown-item text-white" to="">Actionnnnn</Link></li>
                    </ul>
                  </div>
                </div>
